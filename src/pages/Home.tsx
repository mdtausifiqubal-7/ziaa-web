            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-[300px] h-[600px] rounded-[3rem] border-8 border-surface-container-high bg-surface-container overflow-hidden shadow-2xl relative z-10">
                <img 
                  ...
                  alt="A highly detailed close-up of a modern, bezel-less smartphone screen displaying a beautiful, minimalist chat interface with soft pink and purple glassmorphic message bubbles on a deep midnight blue background." 
